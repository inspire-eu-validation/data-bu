...
* Validate each document against the latest INSPIRE official schema(s), using strict XML schema validation. 
  ...
  *  BuildingsCore2D: https://inspire.ec.europa.eu/schemas/bu-core2d/4.0/BuildingsCore2D.xsd
  *  BuildingsCore3D: https://inspire.ec.europa.eu/schemas/bu-core3d/4.0/BuildingsCore3D.xsd
